...
const FILE_URLS = [
    ...
    "https://caltech.box.com/shared/static/j0kxdt9nxnk915burnwqs622ots2ylgv.nc",
]
...
# include the `check_ds` and `calc_sw_alb` functions
include("processing_utils.jl")

include("calculate_sw_alb.jl")
include("calculate_bareground_alb.jl")
include("process_ceres_data.jl")

for output_file in OUTPUT_FILES
    check_ds(output_file)
