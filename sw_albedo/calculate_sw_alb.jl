...
defVar(
    ...
    rsus_file["lat_bnds"],
    ("bnds", "lat");
    attrib = lat_bnds_attrib,
)
defVar(
    sw_alb_file,
    "lon",
    rsus_file["lon"],
    dimnames(rsus_file["lon"]);
    attrib = lon_attrib,
)
defVar(
    sw_alb_file,
    ...
    rsus_file["lon_bnds"],
    ("bnds", "lon");
    attrib = lon_bnds_attrib,
)
defVar(
    sw_alb_file,
    "sw_alb",
    sw_alb,
    dimnames(rsus_file["rsus"]);
