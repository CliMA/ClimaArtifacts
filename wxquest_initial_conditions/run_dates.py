...
Clones the private repo git@github.com:CliMA/WeatherQuest.git into a temporary
directory and runs processing/get_initial_conditions.py from there for each
requested date.
