...
The data were downloaded from [CERES website](https://ceres.larc.nasa.gov/data/)
in June 2026.
...
1. Julia 1.12
2. Account on ceres.larc.nasa.gov
...
7. Click on "Order data" next to SYN1deg – Level 3.
...
10. Click on the "Shopping Cart" button at the top of the page.
11. In the product info column, choose to save the files as yearly and the output
   format as netcdf4 for both data products.
12. Submit order and wait for the order to complete
13. You should get an email sent to you with the subject "Your order is
completed". There should be a file that you can download which include URLs for
downloading the NetCDF files. Download the text file to this directory and
rename it to "radiation_obs.txt".
14. Navigate to this directory in the terminal.
15. Run `julia --project=. create_artifact.jl`.
