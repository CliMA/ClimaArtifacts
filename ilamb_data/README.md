...
All files in this artifact are from the ILAMB dataset which can be found here: [https://www.ilamb.org/ILAMB-Data/](https://www.ilamb.org/ILAMB-Data/)
...
This `.nc` file is the FLUXCOM dataset containing observational data for gross primary productivity.

### 3. `rlus_CERESed4.2_rlus.nc`
This `.nc` file is the CERESed4.2 dataset containing observational data for surface upward LW radiation.

### 4. `rsus_CERESed4.2_rsus.nc`
This `.nc` file is the CERESed4.2 dataset containing observational data for surface upward SW radiation.

## References
For more information about the `evspsbl_MODIS_et_0.5x0.5.nc` file, refer to the following publications:
